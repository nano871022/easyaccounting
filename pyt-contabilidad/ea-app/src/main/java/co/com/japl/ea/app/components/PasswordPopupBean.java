...
@FXMLFile(path = "view/component", file = "password_popup.fxml", nombreVentana = "Confirmacion")
public class PasswordPopupBean extends ABean {

	@FXML
	private TextArea mensaje;
	@FXML
	private PasswordField textEntered;
	@FXML
