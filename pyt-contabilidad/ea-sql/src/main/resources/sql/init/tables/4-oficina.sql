...
ALTER TABLE TBL_OFFICE ADD CONSTRAINT KY_OF_PRIMARY PRIMARY KEY (scode);
ALTER TABLE TBL_OFFICE ADD CONSTRAINT KY_OF_FOREING FOREIGN KEY (scity) REFERENCES TBL_CITY (scode); 