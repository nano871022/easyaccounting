...
ALTER TABLE TBL_ENTRY ADD CONSTRAINT KY_ETY_PRIMARY PRIMARY KEY (scode);
ALTER TABLE TBL_ENTRY ADD CONSTRAINT KY_ETY_WK_FOREING FOREIGN KEY (sworker) REFERENCES TBL_EMPLOYEE(scode);
ALTER TABLE TBL_ENTRY ADD CONSTRAINT KY_ETY_EP_FOREING FOREIGN KEY (senterprise) REFERENCES TBL_ENTERPRISE(scode);
ALTER TABLE TBL_ENTRY ADD CONSTRAINT KY_ETY_DI_FOREING FOREIGN KEY (sdriverin) REFERENCES TBL_PERSON(scode);
ALTER TABLE TBL_ENTRY ADD CONSTRAINT KY_ETY_DO_FOREING FOREIGN KEY (sdriverout) REFERENCES TBL_PERSON(scode);
ALTER TABLE TBL_ENTRY ADD CONSTRAINT KY_ETY_OW_FOREING FOREIGN KEY (sowner) REFERENCES TBL_PERSON(scode);
