...
public class H2PropertiesConstant {
	public final static String PROP_NAME = "h2.properties";
	public final static String PROP_PATH = "./";
	public final static String PROP_JDBC_H2 = "jdbc.h2";
	public final static String PROP_HIBERNATE_CONFIG = "hibernate.config.xml";
