...
ALTER TABLE TBL_PAY ADD CONSTRAINT KY_PY_PRIMARY PRIMARY KEY (scode);
ALTER TABLE TBL_PAY ADD CONSTRAINT FK_PY_B_FOREING FOREIGN KEY (sbank) REFERENCES TBL_BANK(scode);
ALTER TABLE TBL_PAY ADD CONSTRAINT FK_PY_D_FOREING FOREIGN KEY (sdocument) REFERENCES TBL_DOCUMENT(scode);