...
ALTER TABLE TBL_COUNTRY ADD CONSTRAINT KY_C_PRIMARY PRIMARY KEY (scode);
ALTER TABLE TBL_COUNTRY ADD CONSTRAINT KY_C_FOREING FOREIGN KEY (sstate) REFERENCES TBL_PARAMETER(scode);