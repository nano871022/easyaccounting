...
ALTER TABLE TBL_PRODUCT_SUMMARY ADD CONSTRAINT KY_PS_PRIMARY PRIMARY KEY(scode);
ALTER TABLE TBL_PRODUCT_SUMMARY ADD CONSTRAINT KY_PS_IPA_FOREING FOREIGN KEY (sivapercentsaleapply) REFERENCES TBL_PARAMETER(scode);
ALTER TABLE TBL_PRODUCT_SUMMARY ADD CONSTRAINT KY_PS_PD_FOREING FOREIGN KEY (sproduct) REFERENCES TBL_PRODUCT(scode);