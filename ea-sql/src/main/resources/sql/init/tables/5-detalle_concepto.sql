...
ALTER TABLE TBL_CONCEPT_DETAIL ADD FOREIGN KEY (sicaactivity) REFERENCES TBL_ICA_ACTIVITY (scode);
ALTER TABLE TBL_CONCEPT_DETAIL ADD FOREIGN KEY (scostcenter) REFERENCES TBL_CENTER_COST (scode);
...
ALTER TABLE TBL_CONCEPT_DETAIL ADD FOREIGN KEY (sthird) REFERENCES TBL_ENTERPRISE (scode);
