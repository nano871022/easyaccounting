...
ALTER TABLE TBL_CONCEPT_DETAIL ADD CONSTRAINT KY_CD_PRIMARY PRIMARY KEY (scode);
ALTER TABLE TBL_CONCEPT_DETAIL ADD CONSTRAINT KY_CD_SA_FOREING FOREIGN KEY (sicaactivity) REFERENCES TBL_ICA_ACTIVITY (scode);
ALTER TABLE TBL_CONCEPT_DETAIL ADD CONSTRAINT KY_CD_CC_FOREING FOREIGN KEY (scostcenter) REFERENCES TBL_CENTER_COST (scode);
ALTER TABLE TBL_CONCEPT_DETAIL ADD CONSTRAINT KY_CD_CT_FOREING FOREIGN KEY (sconcept) REFERENCES TBL_CONCEPT (scode);
ALTER TABLE TBL_CONCEPT_DETAIL ADD CONSTRAINT KY_CD_CT_FOREING FOREIGN KEY (sconcepttype) REFERENCES TBL_PARAMETER (scode);
ALTER TABLE TBL_CONCEPT_DETAIL ADD CONSTRAINT KY_CD_TD_FOREING FOREIGN KEY (sthird) REFERENCES TBL_ENTERPRISE (scode);
