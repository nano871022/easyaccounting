...
ALTER TABLE TBL_PERSON ADD PRIMARY KEY (scode);
ALTER TABLE TBL_PERSON ADD FOREIGN KEY (sdocumenttype) REFERENCES TBL_PARAMETER (scode);
ALTER TABLE TBL_PERSON ADD FOREIGN KEY (sprofession) REFERENCES TBL_PARAMETER (scode);
