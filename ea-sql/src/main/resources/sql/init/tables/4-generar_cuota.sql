...
ALTER TABLE TBL_GENERATEQUOTE ADD CONSTRAINT KY_GQ_PRIMARY PRIMARY KEY (scode);
ALTER TABLE TBL_GENERATEQUOTE ADD CONSTRAINT FK_GQ_PP_FOREING FOREIGN KEY (speriod) REFERENCES TBL_PARAMETER(scode);
ALTER TABLE TBL_GENERATEQUOTE ADD CONSTRAINT FK_GQ_D_FOREING FOREIGN KEY (sdocument) REFERENCES TBL_DOCUMENT(scode);