...
ALTER TABLE TBL_ENTRY ADD FOREIGN KEY (sowner) REFERENCES TBL_PERSON(scode);
...
ALTER TABLE TBL_ENTRY_REPLACEMENT ADD FOREIGN KEY (sreplacement) REFERENCES TBL_PRODUCT_SUMMARY(scode);
...
ALTER TABLE TBL_ENTRY_SERVICE ADD FOREIGN KEY (sservice) REFERENCES TBL_SERVICE(scode);
